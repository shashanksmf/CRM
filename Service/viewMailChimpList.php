...
$viewListDetails="SELECT listid,APIKEY,type,listname,date_created FROM mailchimp_createlist_details WHERE isactive = 1;";
@mysqli_set_charset($conn,"utf8");
$result = mysqli_query($conn, $viewListDetails);
