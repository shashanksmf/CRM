...
inspinia.controller('homeCtrl', ['$scope', '$rootScope', '$http', '$q',
  ...
  function($scope, $rootScope, $http, $q, $timeout, $state, $stateParams,
    ...
    //autoCompleteList
    $rootScope.autoCompleteListItem = function(emplSearchItem, emplId,
      emplObj) {


      if (emplId && emplId.length > 0) {
        $rootScope.tagSearchedItems.push({
          "searchItem": emplSearchItem,
          "emplID": emplId
        });
        $scope.tagSearchedDetails = [];
      ...
      function pushItemToList() {
        ...
        $rootScope.tagSearchedItems.push({
          "searchItem": originalSearchItem,
          "emplID": emplId
        });
        $rootScope.tagSearchedItems[$rootScope.tagSearchedItems.length -
          1].searchId = [];
        ...
        searchedData.then(function(greeting) {
          greeting.forEach(function(greet) {
            ...
            $rootScope.tagSearchedItems[$rootScope.tagSearchedItems
              .length - 1].searchId.push(greet.id);
    ...
    $rootScope.deleteSearchedTag = function(tag, tagIndex) {
      ...
      $rootScope.tagSearchedItems.forEach(function(items,
        tagSearchDetailsIndex) {
...
inspinia.controller('insertEmplBulkDataCtrl', ['$scope', '$rootScope', '$http',
  '$q', '$timeout', '$state', '$stateParams', 'API',
  function($scope, $rootScope, $http, $q, $timeout, $state, $stateParams,
    API) {
