...
inspinia.controller('companyProfileCtrl', ['$scope', '$rootScope', '$http',
  '$q', 'API', '$state', '$timeout', '$stateParams', 'crmconfig',
  function($scope, $rootScope, $http, $q, API, $state, $timeout,
    $stateParams, crmconfig) {
    ...
    $scope.saveProfile = function() {
      ...
      if (companyId) {
        $scope.companyData.id = companyId;
        API.updateCompanyDetails($scope.companyData).then(function(
          response) {
