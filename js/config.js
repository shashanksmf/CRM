  ...
  .state('charts', {
      ...
      resolve: {
        loadPlugin: function($ocLazyLoad) {
          return $ocLazyLoad.load([{
            reconfig: true,
            serie: true,
            files: ['js/plugins/rickshaw/vendor/d3.v3.js',
      ...
      resolve: {
        loadPlugin: function($ocLazyLoad) {
          return $ocLazyLoad.load([{
            ...
            files: ['js/plugins/chartist/chartist.min.js',
    ...
    .state('charts.c3charts', {
      ...
      resolve: {
        loadPlugin: function($ocLazyLoad) {
          return $ocLazyLoad.load([{
            serie: true,
            files: ['css/plugins/c3/c3.min.css',
              'js/plugins/d3/d3.min.js', 'js/plugins/c3/c3.min.js'
            ]
          }, {
            serie: true,
      ...
      resolve: {
        loadPlugin: function($ocLazyLoad) {
          return $ocLazyLoad.load([{
              ...
              name: 'ui.knob',
              files: ['js/plugins/jsKnob/jquery.knob.js',
                'js/plugins/jsKnob/angular-knob.js'
              ]
            }, {
              files: ['css/plugins/ionRangeSlider/ion.rangeSlider.css',
              ...
              name: 'nouislider',
              files: ['css/plugins/nouslider/jquery.nouislider.css',
              ...
              files: ['css/plugins/colorpicker/colorpicker.css',
                'js/plugins/colorpicker/bootstrap-colorpicker-module.js'
              ]
            }, {
              name: 'ngImgCrop',
              files: ['js/plugins/ngImgCrop/ng-img-crop.js',
                'css/plugins/ngImgCrop/ng-img-crop.css'
              ]
            }, {
              serie: true,
    ...
    .state('forms.file_upload', {
      ...
      resolve: {
        loadPlugin: function($ocLazyLoad) {
          return $ocLazyLoad.load([{
            files: ['css/plugins/dropzone/basic.css',
  ...
  .state('login', {
    ...
    .state('miscellaneous.code_editor', {
      ...
      resolve: {
        loadPlugin: function($ocLazyLoad) {
          return $ocLazyLoad.load([{
            serie: true,
            files: ['css/plugins/codemirror/codemirror.css',
    ...
    .state('miscellaneous.nestable_list', {
      ...
      resolve: {
        loadPlugin: function($ocLazyLoad) {
          return $ocLazyLoad.load([{
            name: 'ui.tree',
            files: ['css/plugins/uiTree/angular-ui-tree.min.css',
      ...
      resolve: {
        loadPlugin: function($ocLazyLoad) {
          return $ocLazyLoad.load([{
            ...
            files: [
              'js/plugins/angular-diff-match-patch/angular-diff-match-patch.js'
            ]
          }]);
        }
      }
      ...
      resolve: {
        loadPlugin: function($ocLazyLoad) {
          return $ocLazyLoad.load([{
            serie: true,
            name: 'angular-ladda',
            files: ['js/plugins/ladda/spin.min.js',
    ...
    .state('miscellaneous.tour', {
      ...
      resolve: {
        loadPlugin: function($ocLazyLoad) {
          return $ocLazyLoad.load([{
            insertBefore: '#loadBefore',
            files: ['js/plugins/bootstrap-tour/bootstrap-tour.min.js',
              'css/plugins/bootstrap-tour/bootstrap-tour.min.css'
            ]
          }, {
            name: 'bm.bsTour',
            files: [
              'js/plugins/angular-bootstrap-tour/angular-bootstrap-tour.min.js'
            ]
          }]);
        }
      }
    ...
    .state('tables.data_tables', {
      ...
      resolve: {
        loadPlugin: function($ocLazyLoad) {
          return $ocLazyLoad.load([{
            serie: true,
            files: ['js/plugins/dataTables/datatables.min.js',
    ...
    .state('commerce.product_details', {
      ...
      resolve: {
        loadPlugin: function($ocLazyLoad) {
          return $ocLazyLoad.load([{
            files: ['css/plugins/slick/slick.css',
